...
export const NOVIDADES = [
  {
    ...
    data: '2026-09-12',
    itens: [
      'Novo: o administrador agora pode excluir uma escala gerada (na tela Escala, escolha o mês e toque em "Excluir esta escala"). Pede confirmação antes de apagar.',
    ],
  },
  {
    versao: '1.5.4',
    data: '2026-08-19',
    itens: [
      'As caixinhas de horário ainda ficavam sem a borda direita em celulares mais estreitos (o campo de hora tem uma largura mínima do próprio sistema). Reduzimos as margens ao redor pra sobrar espaço de verdade pra ele.',
    ],
  },
  {
    versao: '1.5.3',
